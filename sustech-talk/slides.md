...
南方科技大学物理系 · 2026 年 6 月 17 日
</div>

<div class="abs-bl m-6 text-xs" style="color: var(--stone); max-width: 420px; text-align: left; line-height: 1.5;">
Dec 2025 – Apr 2026 · 16 papers · 11 on arXiv · 3 published in Phys. Rev. C + 1 published in Phys. Lett. B + 1 accepted in Phys. Rev. C
</div>
...
2025 年 12 月至 2026 年 4 月. 11 篇上 arXiv, 其中 3 篇已发表于 PRC、1 篇已发表于 PLB、1 篇 PRC 已接收; 另有 1 篇已投稿, 4 篇准备中. Solo × 9, 同济本地组 × 5, w/ Furnstahl × 2, w/ Hu+Phillips+Furnstahl × 1 (重叠计).
</div>
