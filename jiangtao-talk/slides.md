...
开场: 各位老师下午好, 谢谢江涛老师的邀请. 我知道这是个以实验为主的组, 所以今天会把核物理的技术细节压到最低, 把 workflow、失败模式、以及"哪些环节能搬到实验工作流"这三件事讲清楚. 过去四个月我在 LLM 日常协助下做了 16 篇论文, 但今天的焦点不是这个数字, 是让这个数字变得可能的那套人机分工, 以及它在 s-SNOM 数据处理、pump-probe 批量拟合、FDTD 扫描、DFT/BSE 辅助计算这类实验组日常里可能意味着什么.
